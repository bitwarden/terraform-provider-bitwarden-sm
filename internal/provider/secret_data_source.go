...
func (s *secretDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	...
	tflog.Debug(ctx, "Creating Bitwarden Secrets Manager Client for Secret Datasource")
	...
	if err != nil {
		resp.Diagnostics.AddError(
			"Unable to Create Bitwarden Secrets Manager Client for Secret Datasource",
	...
	if err != nil {
		resp.Diagnostics.AddError(
			"Unable to Authenticate Bitwarden Secrets Manager Client for Secret Datasource",
